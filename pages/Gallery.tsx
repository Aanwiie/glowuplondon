...
// -- DATA CONFIGURATION --
// Updated with your specific local paths for the 3rd row
const galleryData: GalleryItem[] = [
  ...
  // -- NEW ROW ADDED BELOW --
  { id: 9, src: "/gallery/9.jpeg", title: "Gallery 9" },
  { id: 10, src: "/gallery/10.jpeg", title: "Gallery 10" },
  { id: 11, src: "/gallery/11.jpeg", title: "Gallery 11" },
  { id: 12, src: "/gallery/17 (1).jpeg", title: "Gallery 17" },
];
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-center items-center">
            ...
            <div className="w-full h-[85vh] flex items-center justify-center pointer-events-none">
              <img
